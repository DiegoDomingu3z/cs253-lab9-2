...
# Module 9 Lab Guide (part 2)

[Lab Introduction Video](https://boisestate.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=8cfbe2e4-d6fd-41aa-b010-b010004c0217)
...
You are welcome to user the values shown below in the Future Possibilities Database, or create your own unique theme. Each list should contain a minimum of 5 options, except HOME_LIST which may contain only 4. Take your time and have some fun with this, I certainly did! :)
...
#### Expected Program Output (the values may be customized if you wish)
```
...
3. Implement test cases in mytests.c to validate each function behaves as expected. This is known as unit testing and you can find a list of suggested tests in the [Lab Activity Test Plan](LabActivityTestPlan.md). Be sure to run these tests with valgrind as indicated in the Problem Description above.
4. Enter the program code to create the M.A.S.H Game as described in the Problem Description.
5. Test the program using the example above to ensure it functions as expected.
